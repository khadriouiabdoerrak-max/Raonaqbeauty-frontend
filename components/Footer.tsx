...
const trust = [
  "الدفع عند الاستلام بعد ما تقلبي",
...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#1C1412] text-white" dir="rtl">
      <div className="h-px bg-gradient-to-l from-transparent via-[#C4A484]/50 to-transparent" />

      <div className="container mx-auto px-4 py-14 md:py-20">
        <div className="max-w-xl">
          <p className="text-[11px] font-black tracking-[0.42em] text-[#C4A484]">RAONAQ</p>
          <p className="mt-3 text-2xl font-black leading-tight md:text-3xl">{SITE.fullName}</p>
        ...
        <div className="mt-12 grid gap-10 border-t border-white/10 pt-12 sm:grid-cols-2 lg:grid-cols-3 lg:gap-16">
          <div>
            <p className="text-[11px] font-black tracking-[0.28em] text-[#C4A484]">روابط</p>
          ...
          <div>
            <p className="text-[11px] font-black tracking-[0.28em] text-[#C4A484]">ثقتك</p>
            <ul className="mt-5 space-y-3">
              {trust.map((line) => (
          ...
          <div>
            <p className="text-[11px] font-black tracking-[0.28em] text-[#C4A484]">تواصل</p>
              ...
              <div className="mt-6 flex gap-2">
                {social.instagram && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex h-9 w-9 items-center justify-center rounded-full border border-white/12 text-white/70 hover:border-[#C4A484] hover:text-white"
      ...
      <div className="border-t border-white/10">
        <div className="container mx-auto flex flex-col gap-2 px-4 py-5 text-[12px] font-medium text-white/35 md:flex-row md:items-center md:justify-between">
          <p>© {new Date().getFullYear()} رونق — Raonaq Beauty. جميع الحقوق محفوظة.</p>
