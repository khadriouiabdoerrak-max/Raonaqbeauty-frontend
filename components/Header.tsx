...
export default function Header() {
  ...
  return (
    <div className="sticky top-0 z-50">
      ...
      >
        <div className="container mx-auto flex h-[88px] items-center justify-between gap-4 px-4 md:h-[104px]">
          <Link href="/" className="flex h-[72px] shrink-0 items-center md:h-[88px]" aria-label="Raonaq — accueil">
