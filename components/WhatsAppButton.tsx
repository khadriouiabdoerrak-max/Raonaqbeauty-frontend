  ...
  return (
    <div className="fixed bottom-20 md:bottom-6 left-6 z-50 flex items-center gap-4 flex-row-reverse" dir="ltr">
      <a
        ...
        className="w-14 h-14 bg-whatsapp text-white rounded-full flex items-center justify-center shadow-[0_4px_14px_rgba(37,211,102,0.4)] hover:scale-110 hover:shadow-[0_6px_20px_rgba(37,211,102,0.6)] transition-all duration-300 relative"
        aria-label={`واتساب ${getWhatsAppDisplay()}`}
      >
      ...
      <div
        ...
        dir="rtl"
      >
        <p className="text-sm font-bold text-warm-black">محتاجة مساعدة؟</p>
