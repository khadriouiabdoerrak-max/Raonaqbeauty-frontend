...
export const products: Product[] = [
  {
    ...
    voice: {
      name: "Hanna",
      city: "Casablanca",
      text: "Beaucoup plus rapide. Mes cheveux ont l’air faits en salon — je suis vraiment contente.",
    },
    reviews: [
      {
        name: "Rania",
        city: "Rabat",
        rating: 5,
        text: "J’ai arrêté le salon. Ça sèche et coiffe en même temps — brillance, tenue, je l’adore.",
      },
      {
        name: "Camille",
        city: "Marrakech",
        rating: 5,
        text: "Je me lève souvent en retard. Maintenant je me coiffe correctement en quelques minutes.",
      },
      {
        name: "Fatima",
        city: "Casablanca",
        rating: 5,
        text: "Cheveux longs et épais : avant 45 min, maintenant 25 max. Plus de frisottis, plus de brillance.",
      },
      {
        name: "Léa",
        city: "Tanger",
        rating: 5,
        text: "Un des meilleurs achats beauté. Cheveux moins ternes, plus soyeux — presque tous les jours.",
      },
      {
        name: "Sara",
        city: "Fès",
  ...
  },
  {
    ...
    voice: {
      name: "Maya",
      city: "Casablanca",
      text: "Je l’utilise presque tous les jours : ça sèche vite et laisse moins de frisottis.",
    },
    reviews: [
      {
        name: "Daniela",
        city: "Rabat",
        rating: 5,
        text: "Séchage rapide, geste simple. Sur cheveux épais, le lisse tient mieux qu’avant.",
      },
      {
        name: "Carolina",
        city: "Agadir",
        rating: 5,
        text: "Moins de frisottis, plus de contrôle sur les pointes — sans changer d’outil.",
      },
      {
        name: "Sara",
        city: "Meknès",
        rating: 5,
        text: "Cheveux plus doux, plus brillants, mieux tenus jusqu’au soir.",
      },
      {
        name: "Victoria",
        city: "Tanger",
        rating: 5,
        text: "Moins de temps sous la chaleur, et le bruit est plus supportable qu’un sèche-cheveux classique.",
      },
      {
        name: "Anna",
        city: "Casablanca",
  ...
  },
  {
    ...
    voice: {
      name: "Léa",
      city: "Rabat",
      text: "Compact, facile à tenir — je rattrape ma frange en quelques minutes.",
    },
    reviews: [
      {
        name: "Lena",
        city: "Casablanca",
        rating: 5,
        text: "Je voulais quelque chose de compact pour le sac. Sur les mèches du devant, ça marche vraiment bien.",
      },
      {
        name: "Sophie",
        city: "Marrakech",
        rating: 5,
        text: "En voyage, je n’ai plus besoin d’un gros lisseur. Le matin, je corrige les plis du sommeil.",
      },
      {
        name: "Giulia",
        city: "Tanger",
        rating: 5,
        text: "Il tient à côté du makeup. Avant de quitter le bureau, je calme le frisottis de la journée.",
      },
      {
        name: "Nina",
        city: "Fès",
        rating: 5,
        text: "Je le garde dans le sac de sport : après l’effort, le contour du visage redevient net.",
      },
      {
        name: "Inès",
        city: "Casablanca",
  ...
  },
  {
    ...
    voice: {
      name: "Emily",
      city: "Casablanca",
      text: "Enfin du volume et des pointes nettes — sans jongler entre brosse et sèche-cheveux.",
    },
    reviews: [
      {
        name: "Megan",
        city: "Rabat",
        rating: 5,
        text: "Je pensais qu’il finirait au fond d’un tiroir. Maintenant, c’est dans mon rituel.",
      },
      {
        name: "Grace",
        city: "Marrakech",
        rating: 5,
        text: "Ça m’épargne plusieurs étapes quand je dois être prête vite.",
      },
      {
        name: "Sienna",
        city: "Agadir",
        rating: 4,
        text: "J’aime la façon dont ça sculpte les pointes — la coiffure paraît terminée.",
      },
      {
        name: "Clara",
        city: "Tanger",
        rating: 5,
        text: "Cheveux plus lisses, plus soignés, avec une vraie brillance.",
      },
      {
        name: "Didi",
        city: "Casablanca",
  ...
  },
  {
    ...
    voice: {
      name: "Sophie",
      city: "Casablanca",
      text: "Petit format pour le voyage — je corrige mes cheveux le matin sans prendre de place dans la valise.",
    },
    reviews: [
      {
        name: "Lena",
        city: "Rabat",
        rating: 5,
        text: "Compact pour le sac. Sur les longueurs de devant, le résultat est net et rapide.",
      },
      {
        name: "Nina",
        city: "Marrakech",
        rating: 5,
        text: "Dans le sac de sport : après le cours, le contour du visage redevient propre.",
      },
      {
        name: "Inès",
        city: "Tanger",
        rating: 5,
        text: "Parfait pour une retouche quand les cheveux tiennent encore de la veille.",
      },
      {
        name: "Giulia",
        city: "Fès",
        rating: 5,
        text: "Très compact à côté du makeup. Avant de sortir, je calme le frisottis du jour.",
      },
      {
        name: "Léa",
        city: "Casablanca",
  ...
  },
  {
    ...
    voice: {
      name: "Martina",
      city: "Casablanca",
      text: "Je place une mèche, j’appuie — l’outil fait presque tout. Boucles définies, douces, régulières.",
    },
    reviews: [
      {
        name: "Clara",
        city: "Rabat",
        rating: 5,
        text: "Cheveux plus lisses, plus soignés, avec une belle brillance.",
      },
      {
        name: "Sienna",
        city: "Marrakech",
      ...
      },
      {
        ...
        city: "Tanger",
        rating: 5,
        text: "Sécher et lisser sans changer d’outil — c’est ce que je voulais.",
      },
      {
        name: "Jennifer",
        city: "Agadir",
        rating: 5,
        text: "Pour les sorties, le résultat tient. Simple, net, sans passer par le salon.",
      },
      {
        name: "Amelia",
        city: "Casablanca",
        rating: 4,
        text: "D’habitude mes cheveux gonflent vite. En travaillant section par section, le finish est beaucoup plus lisse.",
      },
    ],
    price1: 599,
    price2: 999,
