...
export const products: Product[] = [
  {
    ...
    bestFor: "الطقم الكامل",
    result: "للي بغاو كل الستايلات بلا ما يشريو أدوات متفرقة.",
    features: [
  ...
  },
  {
    ...
    bestFor: "نعومة للشعر الكثيف",
    result: "كتنقص النفشة وكتخلي الشعر مرتب بلمعة ناعمة.",
    features: [
  ...
  },
  {
    ...
    bestFor: "ترتيب سريع",
    result: "مناسب للخدمة، الخروج، والروتين اليومي فدقائق.",
    features: [
  ...
  },
  {
    ...
    bestFor: "حجم ولمعة",
    result: "كيعطي lift واضح، نعومة على الطول، وحضور بحال الصالون.",
    features: [
      "حجم واضح من الجذور",
      "تصفيف فخطوة وحدة",
